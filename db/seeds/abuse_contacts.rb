...
module Seeds
  class AbuseContacts
    CONTACTS = [
      ...
      { name: "Cloudflare", contact_type: :registrar, method: :web_form, web_form_url: "https://abuse.cloudflare.com/", priority: 10, hostname_patterns: [ "cloudflare.com", "cloudflare.net", "pages.dev" ], notes: "The abuse@cloudflare.com email will not work and will redirect you to the form." },
      ...
      { name: "GoDaddy", contact_type: :registrar, method: :web_form, web_form_url: "https://supportcenter.godaddy.com/AbuseReport", priority: 10, hostname_patterns: [ "domaincontrol.com", "secureserver.net", "godaddy.com" ] },
      { name: "Host Arabia", contact_type: :registrar, method: :email, email: "dom@tasjeel.ae", priority: 10 },
      { name: "Hostinger", contact_type: :registrar, method: :web_form, email: "abuse@hostinger.com", web_form_url: "https://www.hostinger.com/report-abuse", priority: 10, hostname_patterns: [ "hostinger.com", "hostingersite.com" ] },
      ...
      { name: "NameSilo", contact_type: :registrar, method: :web_form, web_form_url: "https://new.namesilo.com/phishing_report.php", priority: 10, hostname_patterns: [ "namesilo.com" ] },
      ...
      { name: "Porkbun", contact_type: :registrar, method: :web_form, web_form_url: "https://porkbun.com/abuse", priority: 10, hostname_patterns: [ "porkbun.com" ] },
      ...
      { name: "Tucows", contact_type: :registrar, method: :web_form, web_form_url: "https://tucowsdomains.com/report-abuse/", priority: 10, hostname_patterns: [ "tucows.com", "hover.com" ] },
      ...
      { name: "Amazon AWS", contact_type: :hosting, method: :email, email: "abuse@amazonaws.com", priority: 30, hostname_patterns: [ "amazonaws.com", "cloudfront.net", "*awsdns-*" ] },
      { name: "Deno Deploy", contact_type: :hosting, method: :email, email: "deploy@deno.com", priority: 30, hostname_patterns: [ "deno.dev" ], notes: "Handles deno.dev domains." },
      { name: "DigitalOcean", contact_type: :hosting, method: :email, email: "abuse@digitalocean.com", priority: 30, accepts_xarf: true, hostname_patterns: [ "digitalocean.com", "digitaloceanspaces.com" ], notes: "The mailbox is processed by automated tooling that only accepts X-ARF reports, so accepts_xarf must stay on. DigitalOceanRangeSyncJob keeps ip_ranges current from https://digitalocean.com/geo/google.csv - do not edit them by hand." },
      { name: "ESITED", contact_type: :hosting, method: :email, email: "net-abuse@esited.com", priority: 30 },
      { name: "Google Cloud", contact_type: :hosting, method: :email, email: "google-cloud-compliance@google.com", priority: 30, hostname_patterns: [ "googleusercontent.com", "googlehosted.com", "googledomains.com" ] },
      ...
      { name: "Vercel", contact_type: :hosting, method: :web_form, email: "abuse@vercel.com", web_form_url: "https://vercel.com/abuse", priority: 30, hostname_patterns: [ "vercel-dns.com", "vercel.app", "vercel.com" ] },
      { name: "ZhouyiSat Communications", contact_type: :hosting, method: :email, email: "support@62yun.com", priority: 30 },
      { name: "000webhost.com", contact_type: :hosting, method: :web_form, web_form_url: "https://www.000webhost.com/report-abuse", priority: 30, hostname_patterns: [ "000webhost.com", "000webhostapp.com" ] },
      ...
      { name: "Wix", contact_type: :other, method: :web_form, web_form_url: "http://www.wix.com/upgrade/abuse#!spam-report/c18hy", priority: 50, hostname_patterns: [ "wixdns.net", "wixsite.com", "wix.com" ] },
      { name: "Weebly", contact_type: :other, method: :web_form, web_form_url: "https://www.weebly.com/spam", priority: 50, hostname_patterns: [ "weebly.com", "weeblysite.com" ] },
